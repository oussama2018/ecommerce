  ...
  <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
    <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ Storage::disk('cloudinary')->url($product->image[0]) }}' }">
          <div class="sticky top-0 z-50 overflow-hidden ">
            ...
            <div class="flex-wrap hidden md:flex ">
                ...
                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ Storage::disk('cloudinary')->url($image) }}'">
                <img src="{{ Storage::disk('cloudinary')->url($image) }}" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
              </div>
                @endforeach
