        ...
        <div class="p-4 md:p-5">
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              <img loading="lazy" class="h-[5rem] w-[5rem]" src="{{ filter_var($category->image, FILTER_VALIDATE_URL) ? $category->image : Storage::disk('cloudinary')->url($category->image) }}" alt="{{ $category->name }}">
              <div class="ms-3">
