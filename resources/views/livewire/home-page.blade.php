  ...
  <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
        ...
        <a href="/products?selected_brands[0]={{ $brand->id }}" class="">
          <img src="{{ filter_var($brand->image, FILTER_VALIDATE_URL) ? $brand->image : Storage::disk('cloudinary')->url($brand->image) }}" alt="{{ $brand->name }}" class="object-cover w-full h-64 rounded-t-lg">
        </a>
        ...
        <div class="p-4 md:p-5">
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ Storage::disk('cloudinary')->url($category->image) }}" alt="{{ $category->name }}">
              <div class="ms-3">
